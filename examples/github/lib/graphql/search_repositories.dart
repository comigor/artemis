...
@JsonSerializable(explicitToJson: true)
class SearchRepositories$Query$SearchResultItemConnection with EquatableMixin {
...
@JsonSerializable(explicitToJson: true)
class SearchRepositories$Query with EquatableMixin {
  SearchRepositories$Query();

  factory SearchRepositories$Query.fromJson(Map<String, dynamic> json) =>
      _$SearchRepositories$QueryFromJson(json);

  SearchRepositories$Query$SearchResultItemConnection search;
...
class SearchRepositoriesQuery extends GraphQLQuery<SearchRepositories$Query,
  ...
  SearchRepositoriesQuery({this.variables});
